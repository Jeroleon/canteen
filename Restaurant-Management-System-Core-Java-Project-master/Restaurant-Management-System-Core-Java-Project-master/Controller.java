...
public class Controller {
                    ...
                    case 3:// Forth clock out
                        ...
                        switch (state) {
                            ...
                            case Staff.WORKSTATE_FINISH:
                                ...
                                break;
                            default:
                                printErrorMessageToView(
                                        "Staff:" + rStaff.getFullName() + "has not been on work today.");
                                pause(3);
                                break;
                        }
                        done = true;
    ...
    private void addNewMenuItem() {
        ...
        while (!done) {
            ...
            newType = 0;
            printMessageToView("Enter item type(1:MAIN 2:DRINK 3:SNACKS 4:DESSERT):");
            key = cView.userInput();
            while (newType == 0) {
                try {
            ...
            switch (newType) {
                ...
                case MenuItem.ALCOHOL:
                    printMessageToView("New item type:SNACKS");
                    break;
            ...
            try {
                switch (inputNumber) {
                    ...
                    case 2: // edit price
                        ...
                        break;
                    case 3: // edit type
                        printMessageToView("Input new type(1:Main 2:Drink 3:Snacks 4:Dessert):");
                        key = cView.userInput();
